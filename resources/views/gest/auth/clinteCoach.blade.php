            ...
            <div class="row row-cols-1  row-cols-md-1 row-cols-lg-2   pb-5 mb-5 mt-5 pt-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px"
                                         style="background-image: url({{ asset('imgs/users/' . Auth::user()->profile_img) }});"></div>
                ...
                <div class="col col-lg-8 px-5 pt-8 pt-lg-0  ">
                    ...
                    <form class="row px-0 px-lg-5 px-sm-0 px-md-0 fw-light"
                        ...
                        <div class="col-12 mt-4">
                            <label for="" class="form-label fs-25 text-light opacity-75">كلمة المرور القديمة</label>
                            <input type="password"
                        ...
                        <div class="col-12 mt-4">
                            <label for="" class="form-label fs-25 text-light opacity-75">كلمة المرور الجديدة</label>
                            <input type="password"
                                   class="form-control bg-primary-op text-muted fs-25 py-3 ps-4 border-0"
                                   name="newpassword"
                                   placeholder="********************">
...
@section('scripts')
    ...
    <script>var hostUrl = "coustom/assets/";</script>
