                            ...
                            <form class="mt-5 w-50 mx-auto" action="{{ route('coach.profile.update') }}" method="post"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" type="text" class="form-control" id="description"
                                              aria-describedby="titleHelp">{{auth()->user()->description}}</textarea>
                                </div>
                                @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="form-group d-flex justify-content-between">
                                    ...
                                    <div class="">
                                        <img src="{{ url('imgs/coaches/' . Auth::user()->profile_image) }} "
                                             width="100px"
                                             height="100px" alt="">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a class="btn btn-light" href="{{ route('profile.editCoachPassword') }}">Update
                                        password</a>
