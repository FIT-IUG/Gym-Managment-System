...
@section('main-content')
    ...
    <section class="bg-primary pt-5 ">
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3  pb-5">
                @foreach($blogs as $blog)
                 ...
                 <span>
                  ...
                  <small class="text-muted">{{\Carbon\Carbon::parse($blog->created_at)->format('Y-m-d')}}</small>
                 </span>
                                <a href="" class="text-warning">اذهب إلى الموقع</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                {{--                <div class="col ">--}}
                {{--                    <div class="card h-100 text-white bg-transparent border-0 ">--}}
                {{--                        <img src="assets/img/Blog/2.svg" class="card-img-top" alt="...">--}}
                {{--                        <div--}}
                {{--                            class="card-img-overlay card-footer d-flex justify-content-start align-items-center pt-5   mt-5 ">--}}
                {{--                            <div--}}
                {{--                                class="bg-warning d-flex align-items-center align-content-center justify-content-center  rounded-5 mt-4  ">--}}
                {{--                                <img src="assets/img/Blog/aa.svg" class="  pe-2 py-2" alt="">--}}
                {{--                                <h5 class="card-title   ms-2 pe-4 mt-2 ms-4 text-dark ">احمد مراد</h5>--}}
                {{--                            </div>--}}
                {{--                        </div>--}}
                {{--                        <div class="card-body  ps-5 pe-0">--}}
                {{--                            <h5 class="card-title ">اليوجا وفوائدها للجسم </h5>--}}
                {{--                            <p class="card-text ps-5 fs-16 mt-3 text-muted">اليوجا وفوائدها للجسم اليوجا واليوغا--}}
                {{--                                وفوائدها للجسم وفوائدها للجسم اليوجا وفوائدها للجسم.</p>--}}
                {{--                        </div>--}}
                {{--                        <div--}}
                {{--                            class="border border-white border-opacity-25 border-start-0 border-end-0 border-bottom-0 d-flex justify-content-between pt-2">--}}
                {{--                 <span>--}}
                {{--                  <img src="assets/img/Blog/calendar.svg" alt="">--}}
                {{--                  <small class="text-muted">10/5/2023</small>--}}
                {{--                 </span>--}}
                {{--                            <a href="" class="text-warning">اذهب إلى الموقع</a>--}}
                {{--                        </div>--}}
                {{--                    </div>--}}
                ...
                {{--                <div class="col ">--}}
                {{--                    <div class="card h-100 text-white bg-transparent border-0 ">--}}
                {{--                        <img src="assets/img/Blog/3.svg" class="card-img-top" alt="...">--}}
                {{--                        <div--}}
                {{--                            class="card-img-overlay card-footer d-flex justify-content-start align-items-center pt-5   mt-5 ">--}}
                {{--                            <div--}}
                {{--                                class="bg-warning d-flex align-items-center align-content-center justify-content-center  rounded-5 mt-4  ">--}}
            ...
            {{--                <div class="col ">--}}
            {{--                    <div class="card h-100 text-white bg-transparent border-0 ">--}}
            {{--                        <img src="assets/img/Blog/4.svg" class="card-img-top" alt="...">--}}
            {{--                        <div--}}
            {{--                            class="card-img-overlay card-footer d-flex justify-content-start align-items-center pt-5   mt-5 ">--}}
            {{--                            <div--}}
            {{--                                class="bg-warning d-flex align-items-center align-content-center justify-content-center  rounded-5 mt-4  ">--}}
            ...
            {{--                <div class="col ">--}}
            {{--                    <div class="card h-100 text-white bg-transparent border-0 ">--}}
            {{--                        <img src="assets/img/Blog/5.svg" class="card-img-top" alt="...">--}}
            {{--                        <div--}}
            {{--                            class="card-img-overlay card-footer d-flex justify-content-start align-items-center pt-5   mt-5 ">--}}
            {{--                            <div--}}
            {{--                                class="bg-warning d-flex align-items-center align-content-center justify-content-center  rounded-5 mt-4  ">--}}
            ...
            {{--                <div class="col ">--}}
            {{--                    <div class="card h-100 text-white bg-transparent border-0 ">--}}
            {{--                        <img src="assets/img/Blog/6.svg" class="card-img-top" alt="...">--}}
            {{--                        <div--}}
            {{--                            class="card-img-overlay card-footer d-flex justify-content-start align-items-center pt-5   mt-5 ">--}}
            {{--                            <div--}}
            {{--                                class="bg-warning d-flex align-items-center align-content-center justify-content-center  rounded-5 mt-4  ">--}}
