...
{{--                        class="text-light font-weight-bold">{{$boughtPackage->number_of_sessions}}</span></p>--}}
                ...
                <p class="card-text text-secondary">Purchased at :<span
                        class="text-light font-weight-bold">{{ \Carbon\Carbon::parse($boughtPackage->created_at)->format('Y-m-d') }} </span>
                </p>
            </div>
        </div>
    </div>
