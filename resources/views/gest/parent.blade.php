                    ...
                    <ul class="dropdown-menu bg-secondary-op py-4">
                        <li>
                            <a class="dropdown-item f12 text-white px-3 {{ Request::is('time_of_work') ? 'active' : '' }}"
                               href="{{ route('time_of_work') }}">أوقات العمل</a></li>
                ...
                @if(auth()->check())
                    ...
                    <li class="nav-item dropdown  list-unstyled d-none d-lg-block me-5">
                        ...
                        <ul class="dropdown-menu bg-secondary-op py-4  text-center">
                            ...
                            <li><a class="dropdown-item f12 text-white " href="My Coach.html">المدربين </a></li>
                            <li class="bg-light opacity-25">
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item f12 text-white " href="Workout schedule.html">جدول التمرين </a>
                            </li>
                            <li class="bg-light opacity-25">
                                <hr class="dropdown-divider">
                            </li>
                            <li>
                                <a class="dropdown-item f12 text-danger  " href="{{ route('logout') }}" onclick="event.preventDefault();
        ...
        <div class="row  d-flex justify-content-between">
            <div class="col-md-2 pt-5">
                ...
                <ul class="list-unstyled  fs-25  pe-0">
                    <li class="pb-2 "><a class="text-decoration-none text-white " href="#">الرئيسية</a></li>
                    <li class="pb-2"><a class="text-decoration-none text-white " href="#">الخدمات</a></li>
                    <li class="pb-2"><a class="text-decoration-none text-white " href="#">العضوية</a></li>
            ...
            <div class="col-md-2 pt-5 ">
                ...
                <ul class="list-unstyled  pe-0  fs-25">
                    <li class="pb-2"><a class="text-decoration-none text-white " href="#">لياقة بدنية</a></li>
                    <li class="pb-2"><a class="text-decoration-none text-white " href="#">كمال اجسام</a></li>
                    <li class="pb-2"><a class="text-decoration-none text-white " href="#">علاج طبيعي</a></li>
                    <li class="pb-2"><a class="text-decoration-none text-white " href="#">ساونا و بخار</a></li>
            ...
            <div class="col-md-2 pt-5 ">
                ...
                <ul class="list-unstyled text-white  pe-0 ">
                    ...
                    <li class="pb-2"><img src="{{asset('assets/img/footer/2.svg')}}" alt=""><a
                            class="text-decoration-none text-white fs-25 pe-1 " href="#"> 059-5160200</a></li>
                    <li class="pb-2"><img src="{{asset('assets/img/footer/2.svg')}}" alt=""><a
                            class="text-decoration-none text-white fs-25 pe-1 " href="#"> 059-9627171</a></li>
                    <li class="pb-2 pt-3"><a class="text-decoration-none text-white fw-bold " href="#">للإناث:</a>
                    </li>
                    <li class="pb-2"><img src="{{asset('assets/img/footer/1.svg')}}" alt=""><a
                            class="text-decoration-none text-white fs-25 pe-1" href="#"> 059-7665870</a></li>
                </ul>
            </div>
                    ...
                    <ul class="list-inline text-left footer-icons ">
                        <li class="list-inline-item  text-center ">
                            <a class=" " target="_blank" href="https://www.whatsapp.com/"><img
                                    src="{{asset('assets/img/footer/4.svg')}}" class=" w-75" alt=""></a>
                        </li>
                        <li class="list-inline-item  text-center ">
                            <a class=" " target="_blank" href="http://facebook.com/"><img
                                    src="{{asset('assets/img/footer/5.svg')}}" class=" w-75" alt=""></a>
                        </li>
                        <li class="list-inline-item  text-center ">
                            <a class=" " target="_blank" href="https://www.instagram.com/"><img
                                    src="{{asset('assets/img/footer/6.svg')}}" class=" w-75" alt=""></a>
                        </li>
                        <li class="list-inline-item  text-center ">
                            <a class="  " target="_blank" href=""><img src="{{asset('assets/img/footer/7.svg')}}"
                                                                       class=" w-75"
                                                                       alt=""></a>
                        </li>
                    </ul>
