                            ...
                            <div class="row">
                                <div class="col-sm-4 border-right">
                                    <div class="description-block">
                                        @role('admin')
                                        <a href="{{ route('profile.edit') }}" class="btn btn-sm bg-dark">Edit
                                            Profile</a>
                                        @endrole
                                        @role('coach')
                                        <a href="{{ route('coach.profile.edit',auth()->user()->id) }}"
                                           class="btn btn-sm bg-dark">Edit Profile</a>
                                        @endrole
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="description-block">
                                        <a href="{{ route('attendance.index') }}" class="btn btn-sm bg-dark">Show
                                            Attendance</a>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 border-right">
                                        <div class="description-block">
                                            ...
                                            <span
                                                class="description-text text-secondary">Welcome ✨ <br> Coach</span>
                                            {{--                                            @endrole--}}
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="description-block">
                                            <a href="{{ route('sessions.index') }}" class="btn btn-sm bg-dark">Show
                                                Sessions</a>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
